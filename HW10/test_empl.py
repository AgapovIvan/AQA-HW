...
from db_utils import Employee, Session
...
def test_add_new_employee():
    ...
    birthate = fake.date_of_birth().isoformat()
    ...
    with Session() as session:
        ...
        assert retrieved_employee.company_id == new_id
        assert retrieved_employee.first_name == name
        assert retrieved_employee.is_active is True
        assert retrieved_employee.last_name == last_name
